...
# --- 1. Load Data ---
links_path = r"C:\Users\ericm\OneDrive\Documents\Portfolio\Digitising_JIT\From_To.csv"
coords_path = r"C:\Users\ericm\OneDrive\Documents\Portfolio\Digitising_JIT\Node_coordinates.csv"
...
# --- 3. Generate the All-Pairs Shortest Path Matrix ---
...
# --- 4. Format into a Square Matrix ---
nodes = sorted(list(G.nodes()))
matrix_df = pd.DataFrame(index=nodes, columns=nodes)

# Fill the matrix
# If a path doesn't exist (e.g., trying to go the wrong way on a one-way), we use 99999 (Big M)
...
# --- 5. Apply Toyota Standard (Optional but recommended) ---
